...
# Creates Solid Queue, Solid Cache, and Solid Cable tables in the primary database.
# Required when using a single DATABASE_URL (e.g. on Render) so queue/cache/cable
# connections all use the same DB and these tables exist.
class AddSolidQueueCacheCableTablesToPrimary < ActiveRecord::Migration[8.1]
  def change
    # Solid Cache
    ...
    # Solid Queue (jobs first for foreign keys)
    ...
    add_index :solid_queue_blocked_executions, :job_id, name: "index_solid_queue_blocked_executions_on_job_id", unique: true, if_not_exists: true
    ...
    add_index :solid_queue_claimed_executions, :job_id, name: "index_solid_queue_claimed_executions_on_job_id", unique: true, if_not_exists: true
    ...
    add_index :solid_queue_failed_executions, :job_id, name: "index_solid_queue_failed_executions_on_job_id", unique: true, if_not_exists: true

    create_table :solid_queue_pauses, if_not_exists: true do |t|
      t.string :queue_name, null: false
      t.datetime :created_at, null: false
    end
    add_index :solid_queue_pauses, :queue_name, name: "index_solid_queue_pauses_on_queue_name", unique: true, if_not_exists: true
    ...
    add_index :solid_queue_processes, [ :name, :supervisor_id ], name: "index_solid_queue_processes_on_name_and_supervisor_id", unique: true, if_not_exists: true
    ...
    add_index :solid_queue_ready_executions, :job_id, name: "index_solid_queue_ready_executions_on_job_id", unique: true, if_not_exists: true
    ...
    add_index :solid_queue_recurring_executions, :job_id, name: "index_solid_queue_recurring_executions_on_job_id", unique: true, if_not_exists: true
    add_index :solid_queue_recurring_executions, [ :task_key, :run_at ], name: "index_solid_queue_recurring_executions_on_task_key_and_run_at", unique: true, if_not_exists: true
    ...
    add_index :solid_queue_recurring_tasks, :key, name: "index_solid_queue_recurring_tasks_on_key", unique: true, if_not_exists: true
    ...
    add_index :solid_queue_scheduled_executions, :job_id, name: "index_solid_queue_scheduled_executions_on_job_id", unique: true, if_not_exists: true
    ...
    add_index :solid_queue_semaphores, :key, name: "index_solid_queue_semaphores_on_key", unique: true, if_not_exists: true

    # Foreign keys for Solid Queue execution tables -> solid_queue_jobs
    if table_exists?(:solid_queue_jobs)
      add_foreign_key :solid_queue_blocked_executions, :solid_queue_jobs, column: :job_id, on_delete: :cascade unless foreign_key_exists?(:solid_queue_blocked_executions, :solid_queue_jobs, column: :job_id)
      add_foreign_key :solid_queue_claimed_executions, :solid_queue_jobs, column: :job_id, on_delete: :cascade unless foreign_key_exists?(:solid_queue_claimed_executions, :solid_queue_jobs, column: :job_id)
      add_foreign_key :solid_queue_failed_executions, :solid_queue_jobs, column: :job_id, on_delete: :cascade unless foreign_key_exists?(:solid_queue_failed_executions, :solid_queue_jobs, column: :job_id)
      add_foreign_key :solid_queue_ready_executions, :solid_queue_jobs, column: :job_id, on_delete: :cascade unless foreign_key_exists?(:solid_queue_ready_executions, :solid_queue_jobs, column: :job_id)
      add_foreign_key :solid_queue_recurring_executions, :solid_queue_jobs, column: :job_id, on_delete: :cascade unless foreign_key_exists?(:solid_queue_recurring_executions, :solid_queue_jobs, column: :job_id)
      add_foreign_key :solid_queue_scheduled_executions, :solid_queue_jobs, column: :job_id, on_delete: :cascade unless foreign_key_exists?(:solid_queue_scheduled_executions, :solid_queue_jobs, column: :job_id)
    end
  end
end
